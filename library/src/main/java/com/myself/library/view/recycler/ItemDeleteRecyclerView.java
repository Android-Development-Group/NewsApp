...
/**
 * 左滑出删除菜单
 * Created by zsw on 16/7/20.
 */
public class ItemDeleteRecyclerView extends BasicRecyclerView {
    ...
    public ItemDeleteRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemDeleteRecyclerView(Context context, AttributeSet attrs, int defStyle) {
